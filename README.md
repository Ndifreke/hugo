...
* two pieces of sample content in the content directory
* The `minimal` theme 

You can remove the `minimal` theme if you so desire and replace it with one you download from https://themes.gohugo.io/ or one you create yourself.
